scr_dialogueText("They couldn't think of something to say");
...
time_dialogue_source = time_source_create(time_source_game, 2.36, time_source_units_seconds, function()
	{
		timeline_position++;
