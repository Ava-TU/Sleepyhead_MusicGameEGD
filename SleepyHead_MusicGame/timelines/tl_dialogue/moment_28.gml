scr_dialogueText("Against the walls, against your rules, against your skin");
...
time_dialogue_source = time_source_create(time_source_game, 4, time_source_units_seconds, function()
	{
		timeline_position++;
