scr_dialogueText("My beard grew down to the floor and out through the doors");
...
time_dialogue_source = time_source_create(time_source_game, 3.8, time_source_units_seconds, function()
	{
		timeline_position++;
