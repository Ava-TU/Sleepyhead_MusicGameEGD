scr_dialogueText("with all their might and all their thirst");
...
time_dialogue_source = time_source_create(time_source_game, 2.6, time_source_units_seconds, function()
	{
		timeline_position++;
